  ...
  return (
    <div className="gnft-div">
      <div className="gnft-content-div">
        <div className="gnft-tagline">
          Get exclusive NFT for your favorite creators
        </div>
        <div className="gnft-title">
          You can only access the encrypted content
          <br /> with cool NFT’s
        </div>
        <div className="gnft-img-div">
          ...
          >
            <img
              src="/assets/images/landing page/grab-nft-creator.png"
              alt="creator-card"
              className="gnft-creator-img"
            />
          </motion.div>
          <motion.div
            className="gnft-token-div-0"
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true }}
            transition={{
          ...
          >
            <div className="gnft-token-div-1">
              <div className="gnft-token-div-2">
                <img
                  src="/assets/images/landing page/grab-nft-token.png"
                  alt="nft-token"
                  className="gnft-token-img"
                />
              </div>
            </div>
          </motion.div>
